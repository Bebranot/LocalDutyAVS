...
/// <summary>
/// _Duty: проигрывает зацикленный звук состояния сканируемой цели, пока открыт анализатор
/// здоровья. Порт из Lost Paradise (#297).
/// </summary>
public sealed class HealthAnalyzerAudioSystem : EntitySystem
{
    [Dependency] private readonly SharedAudioSystem _audio = default!;

    private readonly SoundSpecifier _heartbeat = new SoundPathSpecifier("/Audio/_Duty/HealthAnalyzer/heartbeat.ogg");
    private readonly SoundSpecifier _critical = new SoundPathSpecifier("/Audio/_Duty/HealthAnalyzer/critical.ogg");
    ...
    private void Stop()
    {
        if (_currentAudio != null && Exists(_currentAudio.Value))
