...
ui-options-ambient-music-volume = Громкость динамической музыки:
ui-options-ambient-music-volume-tooltip = Музыка, которая меняется в зависимости от ситуации на станции (бой, спокойствие и т.п.).
ui-options-ambience-volume = Громкость окружения:
ui-options-ambience-volume-tooltip = Фоновые звуки станции: вентиляция, гул техники и подобное.
ui-options-lobby-volume = Громкость лобби и окончания раунда:
ui-options-interface-volume = Громкость интерфейса:
ui-options-ambience-max-sounds = Макс. звуков окружения одновременно:
ui-options-ambience-max-sounds-tooltip = Чем меньше значение, тем ниже нагрузка на звуковую систему, но звуковое окружение станции беднее.
ui-options-lobby-music = Музыка в лобби
ui-options-restart-sounds = Звуки перезапуска раунда
ui-options-restart-sounds-tooltip = Звуковой отсчёт перед принудительным перезапуском раунда.
ui-options-event-music = Музыка событий
ui-options-admin-sounds = Музыка админов
ui-options-admin-sounds-tooltip = Звук, сопровождающий некоторые действия администрации.
ui-options-bwoink-sound = Звук уведомления Ахелпа
ui-options-bwoink-sound-tooltip = Звук нового сообщения в админ-помощи (Ahelp).
ui-options-volume-label = Громкость
ui-options-audio-events-label = Звуковые события
ui-options-chat-highlight-header = Подсветка в чате
ui-options-chat-highlight-sound-tooltip = Проигрывать звук, когда кто-то упоминает выделенное вами слово в чате.
...
ui-options-auto-fill-highlights-tooltip = Автоматически добавлять в список подсветки имя и расу вашего персонажа.
...
ui-options-show-combat-mode-indicators-tooltip = Значок у курсора, показывающий, включён ли боевой режим.
ui-options-opaque-storage-window = Непрозрачность окна хранилища
ui-options-opaque-storage-window-tooltip = Делает фон окна хранилища сплошным вместо полупрозрачного.
...
ui-options-fancy-name-background-tooltip = Затемнённая подложка под именем в облачках речи — легче читать поверх ярких тайлов.
...
ui-options-vp-stretch-tooltip = Тянуть картинку под размер окна вместо фиксированного масштаба ниже.
...
ui-options-vp-low-res-tooltip = Рендерить игру в меньшем разрешении и растягивать до размера окна — повышает FPS на слабом железе.
ui-options-parallax-low-quality = Низкокачественный параллакс (фон)
ui-options-parallax-low-quality-tooltip = Упрощённый фон космоса, снижает нагрузку на видеокарту.
ui-options-ambient-occlusion = Отображать окружающее затенение
ui-options-ambient-occlusion-tooltip = Мягкие тени в углах и стыках объектов. Небольшая нагрузка на производительность.
...
ui-options-static-storage-ui-tooltip = Показывать окно хранилища как панель под хотбаром вместо всплывающего окна.
...
ui-options-colorblind-friendly-tooltip = Заменяет часть цветовых индикаторов на более различимые для дальтоников.
ui-options-reduced-motion = Снижение интенсивности визуальных эффектов
ui-options-reduced-motion-tooltip = Убирает или ослабляет тряску экрана, вспышки и другие резкие эффекты.
...
ui-options-speech-bubble-text-opacity-tooltip = Прозрачность самого текста реплики в облачке речи.
ui-options-speech-bubble-speaker-opacity = Непрозрачность диктора речевого пузыря
ui-options-speech-bubble-speaker-opacity-tooltip = Прозрачность имени говорящего над облачком речи.
ui-options-speech-bubble-background-opacity = Непрозрачность фона речевого пузыря
ui-options-speech-bubble-background-opacity-tooltip = Прозрачность подложки под текстом облачка речи.
