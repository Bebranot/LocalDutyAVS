...
ent-DutyImprovisedTourniquet = самодельный жгут
    .desc = Полоса ткани, туго намотанная на обломок палки. Выглядит примитивно, но затянутая как следует — пережмёт даже крупную артерию.
ent-DutySplint = шина
    .desc = Две деревянные дощечки, стянутые полосами ткани. Грубая, но надёжная фиксация для сломанной кости.
...
trauma-fracture-pain-new-2 = Хруст! { $zone } взрывается болью, в глазах темнеет от агонии.
trauma-fracture-pain-new-3 = Кость не выдерживает — { $zone } обжигает нестерпимая боль, вырывается крик.
trauma-fracture-pain-new-4 = Резкий хруст — { $zone } сломана, боль накатывает волной, дыхание сбивается.
trauma-fracture-pain-escalate-1 = Кость в { $zone } ломается ещё сильнее — новый приступ мучительной боли!
trauma-fracture-pain-escalate-2 = Раздаётся ещё один хруст — { $zone } уже почти не слушается от боли.
trauma-fracture-pain-escalate-3 = Перелом усугубляется — { $zone } пронзает слепящая боль, колени подкашиваются.
...
trauma-splint-need-material = Нужна шина, или две ткани и одна доска в руках.
