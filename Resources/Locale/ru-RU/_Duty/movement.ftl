alerts-duty-endurance-name = Выносливость
alerts-duty-endurance-desc = Запас сил для спринта (зажмите C). На исходе спринт замедляется ниже бега — переведите дух, чтобы восстановиться.
...
duty-sprint-blocked-restrained = Со скованными руками не разбежаться.
