research-technology-mag-fed-pistol = Лазерные револьверы
research-technology-mag-fed-smg = Лазерные пистолеты-пулемёты
research-technology-mag-fed-sniper = Лазерные снайперские винтовки
